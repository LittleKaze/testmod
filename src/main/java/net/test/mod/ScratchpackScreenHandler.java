...
public class ScratchpackScreenHandler extends ScreenHandler
{
    ...
    public ScratchpackScreenHandler(final int syncId, final PlayerInventory playerInventory, final Inventory inventory, final int inventoryWidth, final int inventoryHeight, final Hand hand, String customTitle)
    {
        super(null, syncId);
    ...
    public class BackpackLockedSlot extends Slot
    {
        ...
        public boolean stackMovementIsAllowed(ItemStack stack)
        {
            ...
            if(stack.getItem() instanceof ScratchpackItem) return false;
    ...
    public ItemStack transferSlot(final PlayerEntity player, final int invSlot)
    {
        ...
        if(testItem instanceof ScratchpackItem) return ItemStack.EMPTY;
